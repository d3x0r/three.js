...
Object.assign( Matrix4.prototype, {
	...
	moveNow  ( x,y,z ) { this.origin.addScaledVector( this.forward, z ).addScaledVector( this.up, y ).addScaledVector( this.left, x ) },
	moveForward  ( n ) { this.origin.addScaledVector( this.forward, n ); },
	moveUp  ( n ) { this.origin.addScaledVector( this.up, n ); },
	moveLeft  ( n ) { this.origin.addScaledVector( this.left, n ); },
	moveBackward ( n ) { this.origin.addScaledVector( this.backward, n ); },
	moveDown  ( n ) { this.origin.addScaledVector( this.down, n ); },
